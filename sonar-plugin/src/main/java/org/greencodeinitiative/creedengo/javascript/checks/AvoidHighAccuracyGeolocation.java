...
@DeprecatedEcoCodeRule.Key("EC8")
public class AvoidHighAccuracyGeolocation implements EslintHook, EslintBasedCheck {

    public static final String RULE_KEY = "GCI523";

    @Override
    public String eslintKey() {
        return "@creedengo/avoid-high-accuracy-geolocation";
    }
