...
You'll need to install [ESLint](https://eslint.org/) v10 or v9 and this plugin:
...
| [prefer-on-push-component-change-detection](docs/rules/prefer-on-push-component-change-detection.md) | Ensures Angular component's changeDetection is set to OnPush | ✅  |
